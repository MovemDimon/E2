console.log("✅ Task.js loaded globally");

// تعریف متغیرها در دامنه global
window.TASK_CONFIG = {
  thresholds: {
    invite3: 3,
    invite5: 5,
...
window.balance = parseInt(localStorage.getItem('balance')) || 0;
window.invitedFriends = parseInt(localStorage.getItem('invitedFriends')) || 0;

window.completeTask = function (taskName) {
  console.log("✅ completeTask called for:", taskName);
...
window.updateInviteTaskStatus = function () {
